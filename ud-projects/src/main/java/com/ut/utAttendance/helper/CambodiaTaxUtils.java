...
public class CambodiaTaxUtils {
    ...
    public static Float SalaryTaxCalculateUSD(float totalSalary, double exchangeRate, long taxExemptionForFamily) {
       ...
       /*  if (condition > 0 && condition < 1300000) {
            totalTaxPaid = 0;
        }
        if (condition > 1300001 && condition < 2000000) {
            totalTaxPaid = (condition * 0.05) - 65000;
        }
        if (condition > 2000001 && condition < 8500000) {
            totalTaxPaid = (condition * 0.10) - 165000;
        }
        if (condition > 8500001 && condition < 12500000) {
            totalTaxPaid = (condition * 0.15) - 590000;
        }
        if (condition > 12500001) {
            totalTaxPaid = (condition * 0.20) - 1215000;
        }*/
