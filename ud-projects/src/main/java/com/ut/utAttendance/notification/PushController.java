package com.ut.utAttendance.notification;

import com.ut.utAttendance.helper.ResponseMessageUtils;
import com.ut.utAttendance.model.base.ResponseMessage;
import com.ut.utAttendance.model.notification.DeviceToken;
import com.ut.utAttendance.model.notification.PushMessage;
...
public class PushController {
  ...
  public enum PushType {
        ...
        for (DeviceToken deviceToken : pushMessage.getDeviceTokens()) {
            ...
            switch (deviceToken.getType()) {
                case ANDROID:
                    ...
                    break;
                case IOS:
                    pushIos(deviceToken.getToken(), pushMessage, PushType.DEV);
                    break;
                case WEB:
                    break;
            }
        ...
        for (DeviceToken deviceToken : pushMessage.getDeviceTokens()) {
            switch (deviceToken.getType()) {
                case ANDROID:
                    ...
                    break;
                case IOS:
                    pushIos(deviceToken.getToken(), pushMessage, PushType.PROD);
                    break;
                case WEB:
                    break;
            }
    ...
    public void pushIos(String deviceToken, PushMessage pushMessage, PushType pushType) {
        try {
            ...
            String strJsonBody = "{"
                    ...
                    //  when you use babge you also should use Increase
                    +   "headings: {en: "+title+"},"
